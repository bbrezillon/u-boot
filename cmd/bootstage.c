...
U_BOOT_CMD_WITH_SUBCMDS(bootstage, 1,
	"Boot stage command",
	" - check boot progress and timing\n"
	"report                      - Print a report\n"
	"stash [<start> [<size>]]    - Stash data into memory\n"
	"unstash [<start> [<size>]]  - Unstash data from memory",
	U_BOOT_SUBCMD_MKENT(report, 2, do_bootstage_report),
	U_BOOT_SUBCMD_MKENT(stash, 4, do_bootstage_stash),
	U_BOOT_SUBCMD_MKENT(unstash, 4, do_bootstage_stash));
