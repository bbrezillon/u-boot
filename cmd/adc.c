...
U_BOOT_CMD_WITH_SUBCMDS(adc, 1, "ADC sub-system", adc_help_text,
	U_BOOT_SUBCMD_MKENT(list, 1, do_adc_list),
	U_BOOT_SUBCMD_MKENT(info, 2, do_adc_info),
	U_BOOT_SUBCMD_MKENT(single, 3, do_adc_single))
