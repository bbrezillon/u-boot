...
U_BOOT_CMD_WITH_SUBCMDS(axi, "AXI sub-system", axi_help_text,
	U_BOOT_SUBCMD_MKENT(bus, 1, 1, do_axi_show_bus),
	U_BOOT_SUBCMD_MKENT(dev, 1, 1, do_axi_bus_num),
	U_BOOT_SUBCMD_MKENT(md, 4, 1, do_axi_md),
	U_BOOT_SUBCMD_MKENT(mw, 5, 1, do_axi_mw));
